...
<body>
 ...
 title: 'Apakah anda yakin akan keluar ?', type: 'warning' , showCancelButton: true, confirmButtonColor: '#DD6B55' , confirmButtonText: 'Ya, Sign Out!', closeOnConfirm: false }, function(){ window.location.href = '<?= site_url('sign_out'); ?>'; });">Sign Out</a>
    ...
    <!-- Custom Javascript -->
    <?php
    $arr_uri = array('stok_barang', 'barang', 'pegawai', 'supplier', 'data_pembelian', 'data_penjualan','pelanggan');
    ...
    <script>
        ...
        function save($call) {
            ...
            if (saveData == 'tambah') {
                $call   = $call+'/simpan_add';
            } else {
                $call   = $call+'/simpan_update';
            };
            url = "<?= site_url() ?>"+$call;
